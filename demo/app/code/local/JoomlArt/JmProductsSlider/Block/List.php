...
class JoomlArt_JmProductsSlider_Block_List extends Mage_Catalog_Block_Product_Abstract 
{
    ...
    {
		if ($this->getData("number_items")){
    		$this->_config ['number_items'] = $this->getData("number_items");
    	}
    	
    	if ($this->getData("width")){
    		$this->_config ['width'] = $this->getData("width");
    	}
    	
    	if ($this->getData("height")){
    		$this->_config ['height'] = $this->getData("height");
    	}
    	
    	if ($this->getData("itemwidth")){
    		$this->_config ['itemwidth'] = $this->getData("itemwidth");
    	}
    	 
    	if ($this->getData("itemheight")){
    		$this->_config ['itemheight'] = $this->getData("itemheight");
    	}
